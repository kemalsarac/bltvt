class SaveAppointmentResponse {
  ...
  SaveAppointmentResponse.fromJson(Map<String, dynamic> json) {
    ...
    // if (json['patientAdmissionDetails'] != null) {
    //   patientAdmissionDetails = new List<Null>();
    //   json['patientAdmissionDetails'].forEach((v) {
    //     patientAdmissionDetails.add(new Null.fromJson(v));
    //   });
    // }
  ...
  Map<String, dynamic> toJson() {
    ...
    // if (this.patientAdmissionDetails != null) {
    //   data['patientAdmissionDetails'] = this.patientAdmissionDetails.map((v) => v.toJson()).toList();
    // }
