...
class BilancoScreenviewmodel extends BaseViewModel {
List<Bilanco> Animalname;
MoneyDasboards hesaptablosu;
  double smsBalance;
  ...
  BilancoScreenviewmodel( { key}) : super(key: key);
 


  @override
  FutureOr<void> init() async {
     Animalname = await apiService.bilancoResponse();
     hesaptablosu = await apiService.Moneyhesap();
