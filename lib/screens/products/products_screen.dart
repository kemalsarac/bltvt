...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  Widget build(BuildContext context) {
    return BaseWidget<ProductsScreenViewModel>(
  ...
  Widget buildSearch(BuildContext context, ProductsScreenViewModel vm) {
  ...
  Widget buildProductList(BuildContext context, ProductsScreenViewModel vm) {
    return Expanded(
      child: Container(
