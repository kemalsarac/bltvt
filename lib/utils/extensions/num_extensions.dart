...
extension NumExtensions on num {
  Decimal toDecimal() => this == null ? null : Decimal.parse(toStringAsFixed(8));

  Decimal toDecimalOrDefault([int defaultValue = 0]) =>
      this == null ? Decimal.parse(defaultValue.toStringAsFixed(8)) : Decimal.parse(toStringAsFixed(8));

  num scaleByWidth() => this == null ? 0.0 : ScreenUtil().setWidth(this);

  num scaleByHeight() => this == null ? 0.0 : ScreenUtil().setHeight(this);

  num scaleSp() => this == null ? 0.0 : ScreenUtil().setSp(this);
